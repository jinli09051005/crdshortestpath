...
func main() {
	...
	if err = (&dijkstrav1.Display{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Display")
		os.Exit(1)
	}

	v2knwh := customwebhookv2.CustomKnWebhook{
		ClientConfig: restConfig,
	}
	if err = (&dijkstrav2.KnownNodes{}).SetupWebhookWithManager(mgr, &v2knwh, &v2knwh); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "KnownNodes")
		os.Exit(1)
	}
	v2dpwh := customwebhookv2.CustomDpWebhook{
		ClientConfig: restConfig,
	}
	if err = (&dijkstrav2.Display{}).SetupWebhookWithManager(mgr, &v2dpwh, &v2dpwh); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Display")
		os.Exit(1)
	}
